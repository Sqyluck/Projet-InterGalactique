...
Constellation<WiFiClient> constellation("192.168.43.171", 8088, "ESP8266", "ESP8266_Package", "AZERTY");

MFRC522 mfrc522(SS_PIN, RST_PIN); // Create MFRC522 instance
Thread thrNFC = Thread();
...
void loop(){
  ...
  if((distanceMeasured > defaultValue + 10)||(distanceMeasured < defaultValue - 10)){
